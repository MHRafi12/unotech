...
<div id="carouselId" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <img src="{{asset('assets/img/PC.jpg')}}" class="img-fluid w-100" id="gambar_slider" alt="First slide">
        </div>
        <div class="carousel-item">
            <img src="{{asset('assets/img/laptop.jpg')}}" class="img-fluid w-100" id="gambar_slider" alt="Second slide">
        </div>
    </div>
