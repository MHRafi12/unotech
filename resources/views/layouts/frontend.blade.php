...
<html lang="en">
    <head>
        ...
        <meta content="Unitech menjual laptop, pc aksesoris pc dan laptop">
        <meta content="{{ $title ?? 'App Toko' }}" name="keywords">
        <meta property="og:locale" content="ID_id"/>
        <meta property="og:type" content="website"/>
        <meta property="og:image" content="{{ asset('assets/img/laptop.jpg') }}">
        <!-- Bootstrap CSS -->
        <link rel="shortcut icon" href="{{ asset('assets/img/laptop.jpg') }}">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">Unotech</a>
        ...
        <div class="copyright">
            <div class="container text-center">
                Copyright &copy; <?= date('Y');?> Unotech All Reserved
                <br>
                Unotech
            </div>
        </div>
